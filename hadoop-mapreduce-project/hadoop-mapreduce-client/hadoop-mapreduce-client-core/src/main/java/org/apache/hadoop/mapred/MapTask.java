 ...
 private <T> T getSplitDetails(Path file, long offset) 
  ...
  static class NewTrackingRecordReader<K,V> 
    ...
    NewTrackingRecordReader(org.apache.hadoop.mapreduce.InputSplit split,
      ...
      LOG.info("Palladio debug: Inside NewTrackingRecordReader");
      LOG.info("Palladio debug: creating Recordreader object");
      this.real = inputFormat.createRecordReader(split, taskContext);
      LOG.info("Palladio debug: Recordreader class=" + this.real.getClass());
  ...
  void runNewMapper(final JobConf job,
    ...
    LOG.info("Palladio debug: Mapper class="+taskContext.getMapperClass());
    // make the input format
    org.apache.hadoop.mapreduce.InputFormat<INKEY,INVALUE> inputFormat =
      (org.apache.hadoop.mapreduce.InputFormat<INKEY,INVALUE>)
        ReflectionUtils.newInstance(taskContext.getInputFormatClass(), job);
    
    LOG.info("Palladio debug: Creating object of Input Format " + taskContext.getInputFormatClass());
