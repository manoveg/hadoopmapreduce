...
class JobSubmitter {
  ...
  throws ClassNotFoundException, InterruptedException, IOException {
    ...
    if (ip != null) {
      ...
      LOG.info("Palladio debug: Inside submitJobInternal");
      LOG.info("Palladio debug: submitHostAddress=" + submitHostAddress);
      LOG.info("Palladio debug: submitHostName=" + submitHostName);
    }
  ...
  int writeNewSplits(JobContext job, Path jobSubmitDir) throws IOException,
	...
	LOG.info("Palladio debug: writeNewSplits");
    Configuration conf = job.getConfiguration();
    InputFormat<?, ?> input =
